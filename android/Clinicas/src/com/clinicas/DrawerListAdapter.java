...
public class DrawerListAdapter extends BaseExpandableListAdapter {
	...
	public int getChildrenCount(int grpPos) {
		if(this.groupHeader.size()-1<grpPos)
			return 0;
		return this.groupChildren.get(this.groupHeader.get(grpPos))
                .size();
	}

	public HashMap<String, List<String>> getGroupChildren() {
		return groupChildren;
	}

	public void setGroupChildren(HashMap<String, List<String>> groupChildren) {
