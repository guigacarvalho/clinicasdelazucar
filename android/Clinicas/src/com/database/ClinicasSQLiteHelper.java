...
public class ClinicasSQLiteHelper extends SQLiteOpenHelper {
	  ...
	  private static final String ARTICLES_TABLE_CREATE = "create table "
		      ...
		      + " text not null unique, "+COLUMN_CATEGORY_ID + " text not null, "+COLUMN_DATE + " DATE not null, "
	  ...
	  public static final String LOGIN_TABLE_CREATE = "create table " + TABLE_LOGIN +"("+ COLUMN_ID
		      + " integer primary key autoincrement, " + COLUMN_LOGGED_IN + " boolean, "
			  + COLUMN_USER_ID  + " text not null, "+ COLUMN_USER_NAME  + " text not null , "+ COLUMN_AUTH_TOKEN  + " text not null "+");";
